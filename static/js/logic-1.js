...
var url = "https://api.openaq.org/v1/latest?country=US&date_from=2016-01-01&parameter=o3&limit=10000";
...
d3.json(url, function(data){
  ...
  feature.forEach(function(d){
    var o3_value = d.measurements[0].value;
    ...
    if (units == "ppm"){
      o3_value = o3_value * 1000
      units = "µg/m³"

     };
     ozone_value.push(o3_value);


    console.log(ozone_value);
    ...
    L.circle([latitude, longitude], {
      ...
      fillOpacity: 0.75,
      weight: 1,
      radius: o3_value*1000 // multiplying by a bigger value to ensure different circle size
    }).bindPopup("<h3> City: " + d.city +
      "</h3><hr><p> O3 Value: " + o3_value + " µg/m³"+ "</p>").addTo(map);
