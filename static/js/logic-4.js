...
var url = "https://api.openaq.org/v1/latest?country=US&date_from=2016-01-01&parameter=so2&limit=10000";
...
d3.json(url, function(data){
  ...
  feature.forEach(function(d){
    var value_so2 = d.measurements[0].value;
    ...
    if (units == "ppm"){
      value_so2 = value_so2 * 1000
      units = "µg/m³"

     };
     so2_value.push(value_so2);


    console.log(value_so2 + units) ;
    ...
    L.circle([latitude, longitude], {
      ...
      fillOpacity: 0.75,
      weight: 1,
      radius: value_so2*20000 // multiplying by a bigger value to ensure different circle size
    }).bindPopup("<h3> City: " + d.city +
      "</h3><hr><p> SO2 Value: " + value_so2 + " µg/m³"+ "</p>").addTo(map);
